...
public class ComponentsDiscovererTests : BaseDiscovererTests<ComponentsDiscoverer>
{
    ...
    {
        // arrange
        MockTraitAttribute.GetNamedArgument<string[]>("ComponentNames")
            .Returns(["UI"]);
        ...
        // assert
        traits.Should()
            .Contain(new KeyValuePair<string, string>("Component", "UI"));
    }
    ...
    public void GetTraits_ReturnsComponentsNames_WhenMultipleComponentNamesAreProvided()
    {
        ...
        keyValuePairs.ToList()[1]
            .Should()
            .Be(new KeyValuePair<string, string>("Component", "UI"));
        keyValuePairs.ToList()[2]
            .Should()
            .Be(new KeyValuePair<string, string>("Component", "Database"));
    }
